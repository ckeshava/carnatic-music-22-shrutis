...
const CarnaticSwaraExplorer = () => {
  ...
  const playSwara = (swara) => {
    ...
    const freq = calculateFrequency(baseFrequency, swara.ratio);
    playFrequency(freq);
  };
                ...
                <div className="p-4 bg-amber-50 rounded-lg border border-amber-200">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-3">
                    <div>
                      ...
                      <div className="text-lg font-mono">{calculateFrequency(baseFrequency, selectedSwara.ratio).toFixed(2)} Hz</div>
                    </div>
                    <div>
                ...
                <div className={`p-4 rounded-lg border-2 ${familyColors[selectedSwara.family]}`}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    <div className="bg-white bg-opacity-50 p-2 rounded">
                      ...
                      <div className="font-mono font-bold">{calculateFrequency(baseFrequency, selectedSwara.ratio).toFixed(2)} Hz</div>
                    </div>
                    <div className="bg-white bg-opacity-50 p-2 rounded">
                  ...
                  <div className="mt-3 p-2 bg-white bg-opacity-50 rounded">
                    ...
                    <div className="font-mono text-sm">
                      {baseFrequency.toFixed(2)} × ({selectedSwara.ratio[0]}/{selectedSwara.ratio[1]}) = {calculateFrequency(baseFrequency, selectedSwara.ratio).toFixed(2)} Hz
                    </div>
                  </div>
                </div>
              )}
                ...
                <tbody>
                  {twentyTwoShrutis.map((s, i) => (
                    ...
                    >
                      ...
                      <td className="p-2 border border-amber-200 font-mono">{calculateFrequency(baseFrequency, s.ratio).toFixed(2)}</td>
